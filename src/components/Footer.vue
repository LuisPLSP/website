<template>
  <footer class="bottom" fluid>
    <b-container fluid>
      <b-row class="text-center justify-content-around">
        <b-col class="align-content-start" md="3">
          <img
            style="height: 80px;"
            id="logo"
            class="logo-footer"
          ...
          <b-nav vertical>
            ...
            <b-modal ok-only size="lg" id="privacy" title="Privacy Policy">
              ...
              <p>
                ...
                information that they shared and/or collect in Steps to Podium.
              ...
              <p>
                Steps to Podium follows a standard procedure of using log files.
              ...
              <p>
                Like any other website, Steps to Podium uses 'cookies'. These
              ...
              <P
                ...
                of the advertising partners of Steps to Podium.</P
              >

              <p>
                Third-party ad servers or ad networks uses technologies like
                cookies, JavaScript, or Web Beacons that are used in their
                respective advertisements and links that appear on Steps to
                Podium, which are sent directly to users' browser. They
              ...
              <p>
                Note that Steps to Podium has no access to or control over these
              ...
              <p>
                Steps to Podium's Privacy Policy does not apply to other
              ...
              <p>
                Steps to Podium does not knowingly collect any Personal
            ...
            <b-modal ok-only size="lg" id="terms" title="Terms and Conditions">
              ...
              <p>
                ...
                conditions. Do not continue to use Steps to Podium if you do not
              ...
              <p>
                We employ the use of cookies. By accessing Steps to Podium, you
                agreed to use cookies in agreement with the Steps to Podium's
                Privacy Policy.
              </p>
              ...
              <p>
                Unless otherwise stated, Steps to Podium and/or its licensors
                own the intellectual property rights for all material on Steps
                to Podium. All intellectual property rights are reserved. You
                may access this from Steps to Podium for your own personal use
                subjected to restrictions set in these terms and conditions.
              </p>

              <p>You must not:</p>
              <ul>
                <li>Republish material from Steps to Podium</li>
                <li>Sell, rent or sub-license material from Steps to Podium</li>
                <li>
                  Reproduce, duplicate or copy material from Steps to Podium
                </li>
                <li>Redistribute content from Steps to Podium</li>
              </ul>
              ...
              <p>
                Steps to Podium reserves the right to monitor all Comments and
              ...
              <p>
                You hereby grant Steps to Podium a non-exclusive license to use,
              ...
              <p>
                ...
                of Steps to Podium; and (d) the link is in the context of
              ...
              <p>
                ...
                by sending an e-mail to Steps to Podium. Please include your
              ...
              <p>
                No use of Steps to Podium's logo or other artwork will be
